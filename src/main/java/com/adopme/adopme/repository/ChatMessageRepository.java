...
public interface ChatMessageRepository extends JpaRepository<ChatMessage, Long> {
    /**
     * Finds chat messages between two users, regardless of the order of sender and recipient.
     *
     ...
     * @return A list of chat messages ordered by date and timestamp in ascending order.
     */
